...
![All Attributes](https://github.com/chiaoyuntu/DeepLearning_FaceGen/blob/master/figures/dataset/all_attr.png){:width="600px" height="400px" }
![23 selected Attributes](https://github.com/chiaoyuntu/DeepLearning_FaceGen/blob/master/figures/dataset/23_attr.png){:width="600px" height="400px" }
